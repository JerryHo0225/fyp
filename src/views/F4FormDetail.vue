...
function shouldDisableButton() {
  console.log(this.formInfo.approved_by_user)
  console.log(this.formInfo.Recommended_or_Approved_by_user)
  if (
    this.formInfo.approved_by_user !== null ||
    this.formInfo.Recommended_or_Approved_by_user !== null ||
...
async function get_all_files() {
  ...
  console.log(json.result.file_1)
...
const Update = async function () {
  if (window.confirm('Are you sure you want to update the application?') == false) return
